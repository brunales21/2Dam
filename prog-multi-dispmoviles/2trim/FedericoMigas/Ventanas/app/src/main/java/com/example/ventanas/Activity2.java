...
public class Activity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity2_view);
        ...
        volver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent paginaPrincipal = new Intent(Activity2.this, MainActivity.class);
        ...
        actividad3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent paginaSecundaria = new Intent(Activity2.this, Activity3.class);
