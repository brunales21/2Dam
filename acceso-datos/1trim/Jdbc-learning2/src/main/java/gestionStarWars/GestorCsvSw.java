...
public class GestorCsvSw implements CharactersDAO {
    private Path csvFile;
    private String delimiter;

    public GestorCsvSw(Path csvFile, String delimiter) {
    ...
    public List<Character> getAllCharacters() {
        ...
        try (BufferedReader in = new BufferedReader(new FileReader(csvFile.toString()))) {
            ...
            System.err.println("Error al convertir datos a n�meros: " + e.getMessage());
        }
        return characters;
    }
